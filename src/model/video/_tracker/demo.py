...
from ....io.video import load_video_frames
...
class VideoTrackingMultiplexDemo(VideoTrackingDynamicMultiplex):
            ...
            for storage_key in ["cond_frame_outputs", "non_cond_frame_outputs"]:
                ...
                for f_idx, source_frame_out in source_outputs.items():
                    ...
                    if has_valid_data:
                        ...
                        singleton_consolidated_outputs[storage_key][
                            f_idx
                        ] = singleton_frame_out
    ...
    def add_new_points(
        ...
        if is_new_obj:
            ...
            singleton_state["output_dict"][singleton_storage_key][
                frame_idx
            ] = current_out
    ...
    def add_new_masks(
        ...
        add_to_existing_state = (
            not is_new_state and not reconditioning and has_existing_frame_output
        )
