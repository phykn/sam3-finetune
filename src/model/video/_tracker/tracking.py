...
from .outputs import NO_OBJ_SCORE, SAMOutput, StageOutput
from .prompting import append_stage_output, concat_points, merge_stage_output
    ...
    def forward_image(
        ...
        *,
        ...
        for out_type in backbone_out.keys():
            if not isinstance(backbone_out[out_type], dict):
                continue
            if "backbone_fpn" not in backbone_out[out_type]:
                continue
